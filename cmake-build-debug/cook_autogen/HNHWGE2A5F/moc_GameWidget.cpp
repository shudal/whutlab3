...
QT_MOC_LITERAL(1, 11, 10), // "funcSignal"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 25), // "std::function<void(void)>"
QT_MOC_LITERAL(4, 49, 8) // "funcSlot"

    },
    "GameWidget\0funcSignal\0\0std::function<void(void)>\0"
    "funcSlot"
};
...
void GameWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->funcSignal((*reinterpret_cast< std::function<void(void)>(*)>(_a[1]))); break;
        case 1: _t->funcSlot((*reinterpret_cast< std::function<void(void)>(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (GameWidget::*)(std::function<void(void)> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GameWidget::funcSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GameWidget::funcSignal(std::function<void(void)> _t1)
{
